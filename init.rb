...
Rails.application.config.to_prepare do
  ...
  require_relative 'lib/redmine_datetime_custom_field/field_format_patch'
  require_relative 'lib/redmine_datetime_custom_field/custom_fields_helper_patch'
  require_relative 'lib/redmine_datetime_custom_field/query_patch'
  require_relative 'lib/redmine_datetime_custom_field/custom_field_patch'
end
